...
import org.graphdht.openchord.DHTConnector;
...
//                mainLog("Chord ready...");
                ...
                mainLog("Hits... " + DHTConnector.hitCounter);
...
//                // Shutdown Neo4J
                service.shutdown();
                mainLog("Please restart chord and press enter...");
                scanner.nextLine();
            }
        }
    }
    ...
    private static long readFileIntoNeo(File testfile, GraphDatabaseService service) {
        ...
        while (true) {
            ...
            chordLog("Hits: " + (DHTConnector.hitCounter - hits));
            if (lines % 2000 == 100) {
