 ...
 */
public class OptimizedHashGraphDatabase implements GraphDatabaseService {

    OptimizedNodeManager nodeManager;

    public OptimizedHashGraphDatabase(String string) {
        nodeManager = new OptimizedNodeManager(string);
    }
