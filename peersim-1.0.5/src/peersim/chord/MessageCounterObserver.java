...
/**
 * The last part the basic execution of the protocol needs is the observer, 
 * that computes values like the average number of hops in lookup processing
 * and so on. These results are printed at every specified step time.
 *
 *
 *
 *
...
public class MessageCounterObserver implements Control {
    ...
    public boolean execute() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            System.arraycopy(cp.getLookupMessage(), 0, counters, 0, cp.getLookupMessage().length);
